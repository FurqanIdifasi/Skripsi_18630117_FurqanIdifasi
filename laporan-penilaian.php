...
<body class="A4 landscape">
  ...
  <section class="sheet padding-10mm " style="height: auto;font-size: 10px;">
    ...
    <h4 class="text-center">Laporan Penilaian Pelanggan  <?= date("M", strtotime($_GET['bulan']));  ?> <?= date("y", strtotime($_GET['bulan']));  ?></h4>
<hr>
      <table class="table table-bordered nowrap"  id="example2">
          <thead>
            <tr>
              ...
              <th>Tgl Daftar</th>
              <th>Tgl Selesai</th>
              <th>Kecepatan Progres</th>
              <th>Pelayanan TIM</th>
              <th>Keseluruhan Layanan</th>
              </tr>
          </thead>
          <tbody>
            <?php
